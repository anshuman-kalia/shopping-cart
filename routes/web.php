...
//Route::get('/dc/{id}', 'App\Http\Controllers\IController@display_category');
Route::get('/dc/{id}', 'App\Http\Controllers\IController@display_category')->name('dc.display_category');
